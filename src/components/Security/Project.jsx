      ...
      <div className="lg:pl-24 md:pl-16 pl-6">
        <div className="flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row">
          <div className="py-4 mb-2 w-full">
            ...
            >
              <h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#494b4f]">
                <span className="font-semibold text-white">
                  Redefine what’s possible with our AI services. From machine
                  learning models to intelligent automation.
                </span>{" "}
                we’re shaping a future where technology thinks and acts in the
                service of humanity.
              </h2>
              <a
            ...
            <div className="relative">
              <div className="relative">
                <div className="md:absolute z-[1] top-[-100px] lg:top-[-200px] right-0 shadow-2xl">
                  <img
                    src="https://yorxsm.sirv.com/Images/pexels-cottonbro-6153354.jpg"
                    alt=""
                    loading="lazy"
                    decoding="async"
                    width="1190"
        ...
        >
          <div className="py-4 text-left">
            <div
              className="z-[1] inline-block rounded-full px-2 border-2 border-[#abb4ff] relative font-medium bg-gradient-to-r from-[#939aff] to-[#abb4ff] bg-clip-text text-transparent"
              onMouseEnter={mouseEnterHandler}
              onMouseLeave={mouseLeaveHandler}
            >
            ...
            <h3 className="text-[#939aff] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">
              Completed Tons of projects globally in various fields.
            </h3>
            <p className="mb-3 md:text-3xl text-base font-medium text-white">
