      ...
      <div className="flex md:pl-7 space-x-3 md:space-x-10">
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            className=" h-full w-[3px] mt-7 rounded-md bg-gradient-to-b from-[#ffd6cc] via-[rgb(236,101,71)] to-transparent"
          ></motion.div>
        </div>
        <motion.div
        ...
        >
          ...
          >
            <span className="text-[#ffa28b]">
              {" "}
              At Pleiades Technologies, we turn data into practical insights.{" "}
            </span>
            Our team of data and security experts recognizes the significant
            benefits that can be integrated into your daily operations.
          </h3>
        </motion.div>
      </div>
      <div className="flex justify-between md:space-x-10 max-md:flex-col">
        <HoverCard backgroundColor="#7ee787" direction="flex-row" left="0">
          ...
          >
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="text-black font-semibold">
                Dive into the data deluge with us. Our Big Data solutions
                transform complex datasets into actionable insights, driving
                efficiency and innovation across industries.{" "}
              </span>{" "}
              Our cutting-edge cybersecurity protocols defend your assets from
              cyber threats, ensuring integrity and trust in a connected world.
            </p>
            <div>
              <a
                ...
                href=""
                className=" md:text-xl text-black font-semibold inline-block"
              >
                Learn More
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={` text-black transition inline-block ml-3 ease-in duration-300 mb-[3px] ${
          ...
          <div className="overflow-hidden rounded-s-lg ">
            <img
              className="w-full mt-5 h-auto js-build-in-item build-in-scale-fade build-in-animate"
              width="1209"
              height="890"
              loading="lazy"
              decoding="async"
              alt=""
              aria-hidden="true"
              src="https://miracle.sirv.com/pleiades-assets/green-code.png"
            />
          </div>
        </HoverCard>
        {/* <HoverCard backgroundColor='#7ee787' direction='flex-col' left='-400px'>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                    <img className="w-full  h-auto" width="1208" height="764" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://miracle.sirv.com/pleiades-assets/ship.png" />
                    </div>
                </HoverCard> */}
      </div>
      <Discount />
          ...
          >
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="text-black font-medium">
                The Pleiades Technologies team is driven by values of honesty
                and putting customers first
              </span>{" "}
              We focus on truly understanding our clients needs and
              collaborating closely with them to create customized solutions
              that go above and beyond their expectations.{" "}
            </p>
            <div>
              <a
              ...
              >
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="https://miracle.sirv.com/pleiades-assets/team1.png"
                  />
                  <div className="text-[#7d8590] my-2">Mira</div>
                  <button type="button" className=" bg-[#21262d] rounded-md ">
                    <span className="flex items-center justify-between px-2 py-1 space-x-2">
                      <svg
                        aria-hidden="true"
              ...
              >
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="https://miracle.sirv.com/pleiades-assets/team2.png"
                  />
                  <div className="text-[#7d8590] my-2">Mr Ecolad</div>
                  <button type="button" className=" bg-[#21262d] rounded-md ">
                    <span className="flex items-center justify-between px-2 py-1 space-x-2">
                      <svg
                        aria-hidden="true"
              ...
              >
                ...
                >
                  <img
                    ...
                    src="https://miracle.sirv.com/pleiades-assets/team1.png"
                  />
                  <div className="text-[#7d8590] my-2">Miracle</div>
                  <button type="button" className=" bg-[#21262d] rounded-md ">
                    <span className="flex items-center justify-between px-2 py-1 space-x-2">
                      <svg
                        aria-hidden="true"
                ...
                >
                  ...
                  <button type="button" className=" bg-[#21262d] rounded-md ">
                    <span className="flex items-center justify-between px-2 py-1 space-x-2">
                      ...
                      <span className="Button-label text-[#c9d1d9]">CTO</span>
                    </span>
                  </button>
                </a>
              </motion.div>
              ...
              >
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="https://miracle.sirv.com/pleiades-assets/user4.png"
                  />
                  <div className="text-[#7d8590] my-2">Joel</div>
                  <button type="button" className=" bg-[#21262d] rounded-md ">
                    <span className="flex items-center justify-between px-2 py-1 space-x-2">
              ...
              >
                ...
                >
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    src="https://miracle.sirv.com/pleiades-assets/team5.png"
                  />
